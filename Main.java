...
public class Main {
    ...
    private static void exercise1() {
        System.out.println("\nExercise 1:");
        String myName = "Massimiliano Demma";
        System.out.println (myName.toUpperCase());
        System.out.println (myName.toLowerCase());//Write your code here
    }
    ...
    private static void exercise2() {
        System.out.println("\nExercise 2:");
        // Change these
        String firstName = "Massimiliano";
        String middleName = "Max";
        String lastName = "Demma";
    ...
    private static void exercise3() {
        ...
        String textFrom2Primitives = "Ciao"+5+false; // <--- Edit this line
